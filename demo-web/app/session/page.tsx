        ...
        <div className="mx-auto max-w-5xl">
          <div className="panel-surface mb-6 rounded-2xl p-5">
            ...
            <h1 className="mt-3 text-2xl font-bold md:text-3xl">
              Session Micropayment Demo
            </h1>
            <p className="mt-1 text-sm text-text-secondary">
              Authorize once with a deposit, make multiple API calls without signing, then settle.
              1 signature for N requests — ideal for high-frequency APIs.
            </p>
          </div>
          <SessionFlow />
        </div>
