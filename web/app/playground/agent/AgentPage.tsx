        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="panel-surface mb-6 rounded-2xl p-5">
              ...
              <h1 className="mt-3 text-2xl font-bold md:text-3xl">Agent Demo</h1>
              <p className="mt-1 text-sm text-text-secondary">
                {isMockChainClient
                  ? "Watch an autonomous agent pay for a service with simulated escrow. Works with any x402-compatible agent — no SDK needed."
                  : "Watch an autonomous agent pay for a service with on-chain escrow. Works with any x402-compatible agent — no SDK needed."}
              </p>
            </div>
